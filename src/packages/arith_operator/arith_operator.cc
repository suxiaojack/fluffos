...
char *remove_leading_zero (char * num) {
...
*/
/* n1, n2 : 正整数 */
int compare_value (int negative1, char * n1, int negative2, char * n2, const char * op) {
...
/* 减法处理函式 */
/* n1 : 大正整数, n2 : 小正整数 */
char *subtraction (char * n1, char * n2) {
